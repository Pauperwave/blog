...
::magic-decklist{name="Ponza" author="Francesco Boutet" position="Seat B"}
#main
## Creatures
- 4 Arbor Elf
- 4 Jewel Thief
...
::magic-decklist{name="Red Madness" author="Alex Angeli" position="Seat C"}
#main
## Creatures
- 4 Voldaren Epicure
- 4 Sneaky Snacker
...
::magic-decklist{name="Elves" author="Valerio Sorichetti" position="Seat A"}
#main
## Creatures
- 4 Quirion Ranger
- 4 Llanowar Elves
...
::magic-decklist{name="Red Madness" author="Gabriele Longo" position="Seat B"}
#main
## Creatures
- 4 Voldaren Epicure
- 4 Sneaky Snacker
...
::magic-decklist{name="Pingers" author="Emanuele Feola" position="Seat A"}
#main
## Creatures
...
::magic-decklist{name="Familiar" author="Jacopo Tumiati" position="Seat B"}
#main
## Creatures
...
::magic-decklist{name="Gardens" author="Lorenzo Gallone" position="Seat C"}
#main
## Creatures
- 2 Accursed Marauder
- 3 Crypt Rats
...
::magic-decklist{name="Spy" author="Francesco Paragone" position="Seat A"}
#main
## Creatures
- 2 Quirion Ranger
...
::magic-decklist{name="Jund" author="Simone Buffa" position="Seat B"}
#main
## Creatures
- 3 Krark-Clan Shaman
- 4 Refurbished Familiar
...
::magic-decklist{name="U Faeries" author="Giovanni Sacripanti" position="Seat C"}
#main
## Creatures
- 3 Humbling Elder
- 3 Harrier Strix
