...
Due to the gamble-alike nature of the product rarities are necessary to enhance or lower the drop rate (a SLZ pack contain 3 commons, 2 uncommons, 1 rare and 1 card from any rarity).
...
I think the open letter written by Lega Pauper Italia² is a good thing in the way it express the disatisfaction of part of the player base.
...
The not-draftable argument: SLZ is not meant to be draftable, willingly to change the Pauper rules you can state that products or set not-meant to be played in limited formats (draft, sealed, jump-start) aren't legal.
In my opinion this isn't the right solution. 

By doing so you are excluding early set expansions and reprint sets, like Chronicles, which weren't SLZ is very similar to Chronicles in that aspect: a set full of reprints of wanted cards.³
But, as well, removing Commander sets or products like TMNT Team-Up can be, perhaps, a good thing.

The most "purist" view on this argument is cutting stuff which isn't standard legal is a net improvement of the format. But, due to the FIRE design, the format Pauper is heavily defined by products and set expansions which aren't legal in standard.
On the opposite. the most "liberal" approach, instead, is just allowing every common card beside those in the B&R List.
...
Promo cards can be a purchasable item, see convention promos, and Secret Lair cards be promo cards (see Lightning Bolt SLP - Secret Lair Prize - from Gen Con).⁴
SLD and SLZ are indeed meant to be a limited amount run prints, similarly to promo cards and specific time products (see LotR Holiday Release).⁵
...
Old expansions had weird rarities and from Chronicles to Renaissence it kept its C1 rarity. In Chronicles C1 is uncommon and in Renaissence C1 is common. The thing is, Renaissence is the localized print (French, German, Italian) of Chronicles.
...
8 years later, with the print of Modern Horizons 3 the attention was all on Whriting Chrysalis or on Refurbished Familiar.
...
The view over the format, its metagame and available strategies, play patterns and gameplays are based on what cards are in it and on what you, Wizards of the Coast, cards you chose to have.
...
I, as player and content creator, have in mind a couple cards that I believe it is time to ban from Pauper and at the same time I crave for new addition to the format which is stale and less fun compared to what it used to be.

If the format phylosophy is to make the best out of whatever is available then, adding another limitation, is an improvement?
At the same time, Pauper can be seen or perceived as the all-commons Legacy. Not allowing by principle certain products in a format where all the common cards ever printed in the whole hystory of Magic (MtG Arena is a sort of standalone world) is nothing less than a sly escamotage.
...
Not allowing the Zet Set cards in Pauper, for the people who, instead, don't want to play those cards, is the right call.

There's no really any way to accomodate both parties.
