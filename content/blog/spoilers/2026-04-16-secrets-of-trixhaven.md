...
published: true
sitemap:
  loc: /articles/2026-04-16-secrets-of-trixhaven
tags:
  - Set Review
...
La ricerca [`(game:paper) set:sos rarity:c prefer:best order:set -type:basic`](https://scryfall.com/search?q=%28game%3Apaper%29+set%3Asos+rarity%3Ac+prefer%3Abest+order%3Aset+-type%3Abasic) restituisce 86 nuove carte Pauper in [Secrets of Strixhaven](https://scryfall.com/sets/sos).
...
Sicuramente unire il vantaggio di una carta che fornisce stabilità in early game alla chiusura per il late game migliora la stabilità del mazzo (funziona, di base, come [[Mulldrifter]] e [[Lórien Revealed]]) e, di conseguenza, è necessario del normalissimo testing per capire se il cantrip a costo 2 permette di non rallentare Flicker Tron come invece fanno [[Impulse]] e [[Crop Rotation]], carte che ovviamente richiedono mana colorato (spesso tappato) per funzionare.
::
...
rating: 6.5
---
Carta che se fosse venuta alla luce qualche anno fa mi avrebbe fatto godere nello sperimentarla nel mio Flicker Tron, tuttavia il tempo è tiranno e siamo nel 2026: nonostante l'anno scorso abbia fatto 3 top 8 a 3 Super IPT affrontati con l'archetipo, penso sia stato il canto del cigno visto che il meta al momento è troppo veloce e snowball grazie ai vari monocolor in cima alla catena alimentare.
Avere un cantrip a 2 mana incolori che scava 2 e mette addirittura una carta al cimitero per sfruttare i vari flashback dell'archetipo e il [[Pulse of Murasa]], è davvero interessante se unito ad una possibile chiusura looppabile dal cimitero o che in midgame può stallare race aeree di Utron, Refurbished o Sneaky varie ed eventuali.
La chiave di Flicker Tron nell'era moderna è sopravvivere e highrollare, per questo carte come [[Murmuring Mystic]] resteranno la via visto che contro race medie nel mid game resta un palo incredibile che funge anche da chiusura, non ha la flessibilità e la solidità di questa new entry ma in caso di highroll resta più devastante.
Sicuramente farò la follia di levare mistici e qualsiasi altra chiusura per provare il set o anche solo il 3x di questa bellezza, ma temo che sia già nata vecchia.
Per quanto riguarda altri Tron: Altar non può realisticamente splasharla salvo [[Energy Refractor]] ed ha altre carte che, anche se colorate, scavano nettamente di più come [[Ancient Stirrings]] e [[Malevolent Rumble]]; per Monsters Tron valgono le stesse considerazioni anche se qui la sperimentazione potrebbe essere più valida.
Forse mi son dimenticato di sottolineare finora che stiamo parlando di una sorcery non tutorabile.
::

::magic-card-rating
---
cardName: Visionary's Dance
rating: 6.25
---
::
...
rating: 8
---
Carta che valuto molto positivamente poiché 
come [[Night's Whisper]] effect ha una clausola di attivazione molto bassa (guadagnare vite è estremamente semplice in un formato dove si giocavano le gainlands)
è flessibile (si può scegliere tra creature e terre, in qualsiasi combinazione)
è scalare: funziona come 1x1 se non si guadagnano vite e come 2x1 con il lifegain.
Di conseguenza, l'unica cosa di cui dobbiamo porci il dubbio e dove giocarla: Gates, una qualsiasi versione col verde, sembra automaticamente la casa ideale, poiché, poter scavare sia per le minacce che per [[Basilisk Gate]], al costo di attaccare con [[Sacred Cat]] o [[Outlaw Medic]] sembra in linea con il piano che una lista ipotetica potrebbe avere.
Nel dubbio una lista Naya Gates che gioca i nuovi peschini (questo verde e quello boros), assieme a carte come [[Writhing Chrysalis]] e [[Sneaky Snacker]], sembra tutto fuorché irrealizzabile.
::
...
rating: 6.5
---
Detesto queste clausole in stile guadagno vita che facciano la differenza tra un ceiling notevole e un floor deludente, l'unico enabler che mi viene in mente di affidabile sono le creature con Lifelink di Naya Gates, alle quali ci si potrebbe anche affiancare la nuova [[Shattered Acolyte]]: solo per il fatto che questo archetipo esiste ed ha vari slot flessibili quindi spazio potenziale, salva questa carta da una insufficienza, mi schiero dalla parte dei detrattori.
::

::magic-card-rating
---
cardName: Follow the Lumarets
rating: 7.25
---
::
